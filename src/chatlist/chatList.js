        ...
        if(this.props.chats.length>0){
            return(
                <main className={classes.root}>
                    <Button variant='contained' fullWidth color='primary' className={classes.newChatBtn} onClick={this.newChat}>New Message</Button>
                    <List>
                        {
                                ...
                                return(
                                    <div key={_index}>
                                        <ListItem onClick={()=>this.selectChat(_index)} className={classes.listItem} 
                                            ...
                                            <ListItemText primary={(_user=>_user!==this.props.userEmail)[0]}
                                                secondary={
                                                    <React.Fragment>
            ...
            return(
                <main className={classes.root}>
                    <Button variant='contained' fullWidth onClick={this.newChat} color='primary' className={classes.newChatBtn}>New Chat</Button>
                    <List></List>
                </main>
            )
        }
